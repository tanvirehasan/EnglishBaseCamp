             ...
             <div class="row g-5">
                 <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                     <div class="footer-widget">
                         ...
                         <p class="description mt--20">English & Global Study Base Camp Pvt Ltd is a premier English language training center and a reliable international education consulting firm based in Dhaka.
                         </p>
                 ...
                 <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                     <div class="footer-widget">
                         ...
                         <ul class="ft-link">
                             <li><span>Phone:</span> <a href="#">+8801776688020</a></li>
                             <li><span>E-mail:</span> <a href="mailto:hr@example.com">info@basecampstudy.co.uk</a></li>
                         </ul>
         ...
         <div class="container">
             <div class="row align-items-center">
                 <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-12">
                     <p class="rbt-link-hover text-center text-lg-start">Copyright © 2023 <a href="https://basecampstudy.co.uk">Base Camp Pvt. Ltd.</a> All Rights Reserved</p>
                 </div>
                 <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-12">
