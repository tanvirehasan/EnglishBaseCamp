                            ...
                            <div class="rbt-header-content">
                                <div class="header-info d-none d-lg-block">
                                    <ul class="rbt-information-list">
                                        ...
                                        <li>
                                            <a href="mailto:hello@example.com"><i class="feather-mail"></i>info@basecampstudy.co.uk</a>
                                        </li>
                                        <li>
                                            <a href="#"><i class="feather-phone"></i>+8801776688020</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="rbt-main-navigation d-none d-xl-block">
                        <nav class="mainmenu-nav">
                            <ul class="mainmenu">
                                ...
                                <li class=""><a href="#">Contract Us</a></li>
                            </ul>
                        </nav>
                    </div>
