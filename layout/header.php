                    ...
                    <div class="header-top">
                        ...
                        <div class="header-top-right">
                            <ul class="header-info">
                                <li><a href="tel:+011235641231"><i class="icon-phone"></i>Call: +8801776 68 80 20</a></li>
                                <li><a href="mailto:info@basecampstudy.co.uk" target="_blank"><i class="icon-envelope"></i>Email: info@basecampstudy.co.uk</a></li>
                ...
                <div class="container-fluid">
                    <div class="header-navbar">
                        <div class="header-brand">
                            <div class="logo">
                                <a href="index.html">
                                    <img class="logo-light" src="assets/images/logo/logo.png" width="200px" alt="Corporate Logo">
                                    <img class="logo-dark" src="assets/images/logo/logo.png" width="200px" alt="Corporate Logo">
                                </a>
                            </div>
                        ...
                        <div class="header-mainnav">
                            <nav class="mainmenu-nav">
                                <ul class="mainmenu">
                                    ...
                                    <li class="has-droupdown"><a href="#">Test Prep</a>
                                        <ul class="mega-menu">
                                            <li>
                                                <ul class="submenu mega-sub-menu-01">
                                    ...
                                    <li class="has-droupdown"><a href="#">Services</a>
                                        <ul class="submenu">
                                            ...
                                            <li><a href="#">SOP/ Resume Writing</a></li>
                                            <li><a href="#">Accommodation</a></li>
                                            <li><a href="#">Visa Assistance</a></li>
                                            <li><a href="#">Know Your Score</a></li>
